...
const DeleteConfiramtionModal = ({
  ...
  const categoryQuery = trpc.useQuery(['category.one', { id: categoryId }]);
  const category = categoryQuery.data?.category;

  const deleteCategoryMutation = trpc.useMutation('category.delete', {
    onSuccess: async () => {
      setOpen(false);
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        ...
                        the sub-courses will get deleted.
                      </p>
                    </div>
                  </div>
                </div>
...
export default DeleteConfiramtionModal;
